...
import { ArrowLeft, CheckCircle2, Globe, Zap, Building2, Shield } from "lucide-react";
          ...
          <div className="lg:col-span-7">
            ...
            <div className="space-y-6">
              {division.products.map((product, i) => (
                <Link key={product.id} href={`/divisions/${division.slug}/${product.slug}`} className="block">
