...
import { ArrowLeft, CheckCircle2, Globe, Zap, Cpu } from "lucide-react";
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="pt-32 pb-24 container mx-auto px-6">
        <Link href={`/divisions/${division.slug}`} className="inline-flex items-center gap-2 text-slate-400 hover:text-primary mb-12 transition-colors group font-bold">
