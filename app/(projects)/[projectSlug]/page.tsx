    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="pt-32 pb-24 container mx-auto px-6">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="aspect-video w-full rounded-[3rem] overflow-hidden border border-slate-100 shadow-2xl mb-20">
             <img src={project.image} alt={project.title} className="w-full h-full object-cover" />
          </div>

          <div className="prose prose-slate max-w-3xl mx-auto">
             <h2 className="text-4xl font-heading font-black mb-6">Overview</h2>
             <p className="text-xl text-slate-600 leading-relaxed mb-8">
               {project.content || project.description}
             </p>
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
                <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100">
                   <h4 className="text-sm font-black uppercase tracking-widest text-slate-400 mb-4">Technologies</h4>
                   <div className="flex flex-wrap gap-2">
                      {project.tags.map(tag => (
                        <span key={tag} className="px-3 py-1 rounded-full bg-white border border-slate-200 text-xs font-bold text-slate-600">
                          {tag}
                        </span>
                      ))}
                   </div>
                ...
                <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100">
                   <h4 className="text-sm font-black uppercase tracking-widest text-slate-400 mb-4">Highlights</h4>
