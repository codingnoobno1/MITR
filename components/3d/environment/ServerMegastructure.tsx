...
function ComputeTower({ 
  ...
  const colors = {
    gpu: { primary: "#3b82f6", glow: "#3b82f6" }, // AI Blue
    cloud: { primary: "#e2e8f0", glow: "#ffffff" }, // Cloud White
    security: { primary: "#ef4444", glow: "#ef4444" }, // Security Red
    deploy: { primary: "#22c55e", glow: "#22c55e" } // Deployment Green
  };
    ...
    <group position={position}>
      ...
      <mesh castShadow receiveShadow>
        ...
        <meshStandardMaterial 
          ...
          metalness={0.6} 
          emissive="#1e293b"
          emissiveIntensity={0.08} // Rim Highlight for silhouette
        />
      </mesh>

      {/* LAYER 2: RACK GRIDS (Recessed Bays) */}
      {[-1, 1].map((side) => (
      ...
      {/* LAYER 5: CABLE SPINE (Vertical Routing) */}
